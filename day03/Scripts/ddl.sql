...
CREATE TABLE TBL_USER(
	...
	USER_PHONE VARCHAR2(255) DEFAULT '000-0000-0000',
...
CREATE TABLE TBL_DRINK(
	...
	DRINK_NAME VARCHAR2(255) NOT NULL UNIQUE,
	DRINK_PRICE NUMBER NOT NULL,
	DRINK_STOCK NUMBER DEFAULT 999,
	DRINK_DATE TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
--	당첨상품
...
CREATE TABLE TBL_LOTTERY(
	...
	DRINK_ID NUMBER,
	CONSTRAINT FK_LOTTERY_DRINK FOREIGN KEY(DRINK_ID)
	REFERENCES TBL_DRINK(ID)
);
--	추첨 FK 당첨번호 , FK 당첨상품
CREATE SEQUENCE SEQ_CIRCULATION;
CREATE TABLE TBL_CIRCULATION(
	...
	CONSTRAINT FK_CIRCULATION_PRODUCT FOREIGN KEY(PRODUCT_ID)
...
CREATE TABLE TBL_DELIVERY(
	...
	DELIVERY_START TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
